...
void main() async {
  ...
  //     CashHelper.setData(key: 'userImage', value: 'https://images.lpexels.com/photos/874158/pexels-photo-874158.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
...
Future<void> refreshServer() async {
  await DioHelper.get(url: ApiConstants.signupEndPoint);
